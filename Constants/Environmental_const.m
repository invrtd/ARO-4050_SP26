...
P0   = 2116.22;     % Sea level standard pressure (Lb/Ft^2) (also defined as P_0 below)
Rho0 = 0.0023769;   % Sea level standard density (Slug/Ft^3)

% --- Earth and Gravitational Constants ---
g0 = 32.174;        % Standard acceleration of gravity (Ft/Sec^2)
r  = 2.0856e7;      % Radius of Earth (ft)
r_planet_radius = 6.356766e6; % Earth radius in meters (for reference/other models)
...
T_0_1   = 518.69;     % Base temperature (R)
rho_0_1 = 0.0023769;  % Base density (slug/ft^3)
P_0_1   = 2116.22;    % Base pressure (lb/ft^2)

% Tropopause (Layer 2: 36,089 to 65,617 ft)
h_0_2   = 36089;      % Base altitude (ft)
T_0_2   = 389.99;     % Base temperature (R)
rho_0_2 = 0.000706;   % Base density (slug/ft^3)
