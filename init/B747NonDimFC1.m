...
CDa = CD_alpha;   % Variable defined to match "CD Build up"
...
CLa = CL_alpha;  % Variable defined to match "CL Build up"
...
CDde = CD_delEle; % Variable defined to match "CD Build up"
CL_delEle = 0.3;  % Partial CL with respect to elevator deflection
CLde = CL_delEle; % Variable defined to match "CL Build up"
CM_delEle = -1.4;  % Partial Cm with respect to elevator deflection
CD_ih = 0;          % Induced CD by horizontal stabilizer
CDih = CD_ih;       % Variable defined to match "CD Build up"
CL_ih = 0.65;       % Induced CL by horizontal stabilizer
CLih = CL_ih;       % Variable defined to match "CL Build up"
