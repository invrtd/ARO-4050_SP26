...
C2_ail = U1*(L_p*N_r - L_r*N_p) ...
     ...
     - Y_p*(L_beta + N_beta*A1_bar + N_T_beta*A1_bar) ...
     + U1*(L_beta*B1_bar + N_beta + N_T_beta) - Y_r*(L_beta*B1_bar + N_beta...
     + N_T_beta);
...
D2_bar_ail = [A2_ail B2_ail C2_ail D2_ail E2_ail 0];
...
D2_bar_Rud = [A2_Rud B2_Rud C2_Rud D2_Rud E2_Rud 0];
